...
GITHUB_RAW_BASE = "https://raw.githubusercontent.com/headmkyoto-star/aoi-bluelove-threads/main/"
GITHUB_API_BASE = "https://api.github.com/repos/headmkyoto-star/aoi-bluelove-threads/contents/"
...
def generate_post():
    ...
    prompt = f"""京都河原町のリラクゼーションサロン「あおいブルーラブ」の若い女性セラピストとして、Threadsの短い営業投稿を作成してください。
